...
if (form1.zjy.value=="")
{ alert("请输入验收员！");form1.zjy.focus();return;}
if (form1.zrbz.value=="")
...
<body background="Images/bg2.gif">
       <%        
          ...
          String sql = "select * from zjgz"+chej+" where id='" + v1 + "'";
...
<table align="center" width="557" height="400" border="1" bordercolor="#BEE09C" cellpadding="-2" cellspacing="-2" style="">
  <tr>
    ...
    <table  width="100%" height="70"  border="0"  cellpadding="-2" cellspacing="-2" background="Images/xgzjjl.gif">
      <tr>
        <td></td>
      </tr>
    </table>      
     <form ACTION="gzgl/upzjgztj.jsp" METHOD="POST" name="form1">
      ...
      <table width="559" height="250"  border="0" align="center" cellpadding="-2" cellspacing="0">
          ...
          <tr align="left">
	  	  ...
	  	  <tr>
	  	    <td  height="40" class="style1">质检员</td>
            <td align="left"><input type="text" name="zjy" class="Sytle_text" id="zjy" size="10" value="<%=Rs.getString("zjy")%>">&nbsp;*</td>
