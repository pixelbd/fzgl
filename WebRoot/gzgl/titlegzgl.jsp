...
<tr bgcolor="#ffffff">
    <td colspan="2"><div><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="870" height="150">
      <param name="movie" value="Flash/titletop/gzfk.swf">
      <param name="quality" value="high">
      <param name="wmode" value="transparent">
      <embed src="Flash/titletop/gzfk.swf" width="870" height="150" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent"></embed>
    </object></div></td>
  </tr>
 <tr >
 <%if (islog) { %> 
    <td width="423" background="Images/menubg1.gif"  class="shadow">
     ...
     <a href="gzgl/gzgl.jsp?page=1" >&nbsp;验收反馈故障&nbsp;</a>|
     <a href="gzgl/gzgl.jsp?page=2" >&nbsp;质检发现故障&nbsp;</a>|
     <a href="gzgl/gzgl.jsp?page=3" >&nbsp;车辆典型故障&nbsp;</a>|
     <a href="gzgl/gzgl.jsp?page=4" >&nbsp;不良信息反馈&nbsp;</a>
     </td> 
    <td  align="right" background="Images/menubg3.gif">：：[ <a href="index.jsp" target="_top">首页 </a> ] [<a href="logout.jsp" target="_top"> 注销 </a>]：：</td><%}
    else {   %> 
    <td width="423" background="Images/menubg1.gif"  class="shadow">
      &nbsp;验收反馈故障&nbsp; |  &nbsp;质检发现故障&nbsp; |  &nbsp;车辆典型故障&nbsp; |  &nbsp;不良信息反馈&nbsp;
     </td>
     <td align="right" background="Images/menubg3.gif"> ：：[<a href="gzgl/gzgl.jsp" onClick="Javascript:window.open('../login.jsp','','width=445,height=334')"> 立 即 登 录 </a>][ <a href="index.jsp" target="_top">首页 </a> ] ：：</td>  <%} %>
