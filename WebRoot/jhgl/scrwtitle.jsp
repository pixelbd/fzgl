...
<tr bgcolor="#ffffff">
 ...
 <tr >
    <td width="423" background="Images/menubg1.gif"  class="shadow">
     <a href="jhgl/scrw.jsp?page=1" >&nbsp;生产任务完成情况</a>&nbsp;|&nbsp;
     <a href="jhgl/scrw.jsp?page=2" >月生产计划</a>&nbsp;|&nbsp;
     <a href="jhgl/scrw.jsp?page=3" >日生产计划</a>
     <%
     if(islog) 
   { 
     //调度功能：车间调度，系统管理员可操作
    ...
    if(
       ...
       (
        ...
        {
        %>&nbsp;|&nbsp;<a href="jhgl/scrw.jsp?page=4" >调度管理功能</a><%} %>
    </td> 
    <%%>
    <td  align="right" background="Images/menubg3.gif">：：[ <a href="index.jsp" target="_top">首页 </a> ] [<a href="logout.jsp" target="_top"> 注销 </a>]：：</td>
    <%} else {    %>
    <td align="right" background="Images/menubg3.gif"> ：：[<a href="jhgl/scrw.jsp" onClick="Javascript:window.open('../login.jsp','','width=445,height=334')"> 立 即 登 录 </a>][ <a href="index.jsp" target="_top">首页 </a> ] ：：</td>  <%} %>
  </tr>
  </table>
  </body>
  </html>
