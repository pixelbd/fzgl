...
<table align="center" width="557" height="500" border="1" bordercolor="#BEE09C" cellpadding="-2" cellspacing="-2" >
  <tr>
    ...
    <table  width="100%" height="70"  border="0"  cellpadding="-2" cellspacing="-2" background="Images/tjpjspjl.gif">
      <tr>
        <td></td>
      </tr>
    </table>      
      <form ACTION="pjgl/insertsppjdetl.jsp" METHOD="POST" name="form1"><div align="left"> 
          ...
          <tr align="left">
            <td  height="27" align="left" class="style1">日&nbsp;&nbsp;期 </td>
             <td colspan="3" class="style1" ><input type="text" name="rq" class="Sytle_text" id="rq" ondblClick="loadCalendar(this)">&nbsp;*</td>
	  	  </tr>
	  	  <tr>
	  	    <td   class="style1">配件名称</td>
            <td align="left"><input type="text" name="pjmc" class="Sytle_text" id="pjmc" size="10">&nbsp;*</td>
            <td   colspan="2" class="style1">配件型号</td>
            <td  valign="center"><input type="text" name="xinghao" class="Sytle_text" id="xinghao" size="10"></td>
            <td  class="style1">配件编号</td>
            <td  ><input name="pjbh" type="text" class="Sytle_text" id="pjbh" size="10"></td>
          </tr>
          <tr>
            <td height="25" ><span class="style1">原装车型</span></td>
            <td ><input width="10" name="chexing" type="text" class="Sytle_text" id="chexing" size="10">&nbsp;</td>
            <td colspan="2" class="style1">车&nbsp;&nbsp;号</td>
            <td colspan="2"><input width="20" name="chehao" type="text" class="Sytle_text" id="chehao" size="20"></td>
          </tr>
          <tr>
            <td  class="style1">制造厂代号</td>
            <td colspan="2"><input width="20" name="zzcdh" type="text" class="Sytle_text" id="zzcdh" size="20">&nbsp;*</td>
            <td colspan="1" class="style1">制造时间</td>
            <td colspan="3"><input width="20" name="zzsj" type="text" class="Sytle_text" id="zzsj" size="20">&nbsp;*</td>
          </tr>
          <tr>
          ...
          <td align="left" colspan="6"><input name="guzhang" type="text" class="Style_text" id="guzhang" size="40"></td>
          </tr>
          <tr>
          <td height="25"  align="left"  size="3"><span class="style1">数量</span></td>
          <td align="left" colspan="6"><input name="shuliang" type="text" class="Style_text" id="shuliang"></td>
          </tr>
          <tr>
          <td height="25"  align="left" size="10"><span class="style1">处理</span></td>
          <td align="left" colspan="6"><input name="chuli" type="text" class="Style_text" id="chuli"></td>
          </tr>
         <tr>
