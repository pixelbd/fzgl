...
if (form2.rks.value=="")
{ alert("请输入配件入库数！");form2.rks.focus();return;}
...
<% request.setCharacterEncoding("gb2312");%> 
  ...
  <tr>
      <td><img width="694" height="68" src="Images/ruku.gif" >
      </td>
  </tr>
  <tr>
      <td height="25">
  ...
  <tr>
     ...
     <input type="hidden" name="kc" value="1">配件编号:
     ...
     <tr height="40">
         ...
         &nbsp;配件名称:<input type="text" name="pjname" value=<%=pjname%>>
         </td>
     ...
     <td>&nbsp;配件入库数:<input type="text" name="rks" size="4"></td>
