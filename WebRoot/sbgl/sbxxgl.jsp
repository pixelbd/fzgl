 ...
 <% 
  ...
  { 
    Class.forName("org.gjt.mm.mysql.Driver").newInstance();
      ...
      String tabname="sbxx"; 
      String sql="select a.code,a.mc,a.made,a.cj,a.work,a.fl,b.bz as bz from "+tabname+" as a,banzu as b where a.bz=b.code order by cj,bz,fl,code";
      
    String searchstr="";
    if (request.getParameter("searchstr")!=null) searchstr=new String(request.getParameter("searchstr"));
      
    if ((((String)session.getAttribute("deptment")).equals("22"))||(((String)session.getAttribute("deptment")).equals("admin")))
       { canmodify=true;}
   %>
  <table border="0" align="center"  valign="middle" width="100%" cellpadding=-1 cellspacing=-1 bgcolor="#FFFFFF">
      <tr><td  width="100%" colspan="2">
          ...
          <tr>
              <td  rowspan="3" align="right"><img  width="43" height="43" src="Images/sbxx.gif"></td>
              <td  height="20"></td>
          </tr>
          <tr><td  align="left"><font color="#800040">&nbsp;设备基本信息维护&nbsp;</font></td></tr>
     ...
     <table align="center" valign="top" width="100%"   cellpadding=-2 cellspacing=-2 bgcolor="#FFFFFF">
      <tr><td width="95%" height="28"  align="left" ><img   width="20" height="18" src="Images/add.gif" >
             <a href="sbgl/sbgl.jsp?page=4&pgcode=<%=CurrPg%>" onClick="Javascript:window.open('inssbxx.jsp?','','width=560,height=355')">添加设备信息&nbsp;&nbsp;&nbsp;</a>
      <tr>
          <td>
          <div>
          <!-- 这里开始进行产品质量信息的查询 -->
          <table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" >
                            ...
                            <td  width="10%"><div align="center" class="word_white">设备编码</div></td>
                            <td  width="10%"><div align="center" class="word_white">设备名称</div></td>
                            <td  width="10%"><div align="center" class="word_white">制造时间</div></td>
                            <td  width="15%"><div align="center" class="word_white">制造厂家</div></td>
                ...
                if (Con!= null)
            	{
            		try
            		{
            			...
            			if (CountR>0)
            			{
                            ...
                            <td width="15%" align="center"><%=Rs.getString("work")%></td>
                            <td width="5%" align="center"><%=Rs.getString("fl")%></td>
                            <td width="10%" align="center"><% if (Rs.getString("cj").equals("41")) out.print("郑州检修车间");%>
                            ...
                            <td width="10%" align="center"><%=Rs.getString("bz")%></td>
                            <% if (canmodify) { %>
                            <td width="5%">
                               <div align="center"> 
                               <a href="sbgl/sbgl.jsp?page=4&pgcode=<%=CurrPg%>" title="修改" onClick="Javascript:window.open('upsbxx.jsp?code=<%=Rs.getString("code")%>','','width=565,height=345')">
                               <img src="Images/edit.gif" width="12" height="12" border="0"></a>
                               </div>
                            </td>
                            <td width="5%">
                               <div align="center">
                               <a href="sbgl/sbgl.jsp?page=4&pgcode=<%=CurrPg%>" title="删除" onClick="Javascript:window.open('delsbxx.jsp?code=<%=Rs.getString("code")%>','','width=519,height=155')">
          ...
          <td>
          <a href="sbgl/sbgl.jsp?page=4&pgcode=1">首页</a>
           <%if (CurrPg>1){%>
            <a href="sbgl/sbgl.jsp?page=4&pgcode=<%=CurrPg-1%>">上一页</a> 
            <% } %>
            <%if (CurrPg<CountPg){%>
            <a href="sbgl/sbgl.jsp?page=4&pgcode=<%=CurrPg+1%>">下一页</a> 
            <% }  %>
            <a href="sbgl/sbgl.jsp?page=4&pgcode=<%=CountPg%>">最后一页</a>
            </td>
            </tr>
            </table>
        </div>
