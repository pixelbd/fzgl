...
<tr bgcolor="#ffffff">
    <td colspan="2"><div><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="870" height="150">
      <param name="movie" value="Flash/titletop/sbgl.swf">
      <param name="quality" value="high">
      <param name="wmode" value="transparent">
      <embed src="Flash/titletop/sbgl.swf" width="870" height="150" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent"></embed>
    </object></div></td>
  </tr>
 <tr >
 <%if (islog) { %> 
    <td width="423" background="Images/menubg1.gif"  class="shadow">
     <a href="sbgl/sbgl.jsp?page=1" >设备故障维修管理</a>|
     <a href="sbgl/sbgl.jsp?page=2" >设备星级评比</a>|
     <a href="sbgl/sbgl.jsp?page=3" >设备操作规程</a>
     <% if (((String)session.getAttribute("deptment")).equals("22")||((String)session.getAttribute("deptment")).equals("admin")) 
      { %>
       |<a href="sbgl/sbgl.jsp?page=4" >&nbsp;设备基础信息维护</a><% }
       else {%> |<a href="sbgl/sbgl.jsp?page=5" >&nbsp;设备基础信息查询</a><% } %>
    </td> 
    <td  align="right" background="Images/menubg3.gif">：：[ <a href="index.jsp" target="_top">首页 </a> ] [<a href="logout.jsp" target="_top"> 注销 </a>]：：</td><%}
    else {   %> 
    <td width="423" background="Images/menubg1.gif"  class="shadow">
      &nbsp;  设备故障维修管理 | 设备星级评比 | 设备操作规程
     </td>
     <td align="right" background="Images/menubg3.gif"> ：：[<a href="sbgl/sbgl.jsp" onClick="Javascript:window.open('../login.jsp','','width=445,height=334')">立 即 登 录 </a>][ <a href="index.jsp" target="_top">首页 </a> ] ：：</td>  
   <%} %>
