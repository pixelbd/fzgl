  ...
  <body valign="top">
     <%
      ...
      <tr><td  width="100%" colspan="2">
          ...
          <tr><td  align="left"><font color="#800040">&nbsp;工程质量标准查询&nbsp;</font></td></tr>
     ...
     <table align="center" valign="top" width="100%"   cellpadding=-2 cellspacing=-2 bgcolor="#FFFFFF">
      <tr>
          ...
          <a href="cjgl/cjgl.jsp?page=4&subpg=1&pgcode=1">首页</a>
           <%if (CurrPg>1){%>
            <a href="cjgl/cjgl.jsp?page=4&subpg=2&pgcode=<%=CurrPg-1%>">上一页</a> 
            <% } %>
            <%if (CurrPg<CountPg){%>
            <a href="cjgl/cjgl.jsp?page=4&subpg=2&pgcode=<%=CurrPg+1%>">下一页</a> 
            <% }  %>
            <a href="cjgl/cjgl.jsp?page=4&subpg=2&pgcode=<%=CountPg%>">最后一页</a>
            </td>
            </tr>
            </table>
        </div>
