  ...
  <body valign="top">
     <%
      ...
      <tr><td  width="100%" colspan="2">
          ...
          <tr><td  align="left"><font color="#800040">&nbsp;产品质量标准查询&nbsp;</font></td></tr>
     ...
     <table align="center" valign="top" width="100%"   cellpadding=-2 cellspacing=-2 bgcolor="#FFFFFF">
      <tr>
                ...
                if (Con!= null)
            	{
            		try
            		{
            			...
            			if (CountR>0)
            			{
                            ...
                            <%if (Rs.getString("xz").equals("B")) {%><font color="#000066"><%=Rs.getString("xz")%></font><%} else { if (Rs.getString("xz").equals("A")) { %><font color="#ff0033"><%=Rs.getString("xz")%></font><%} 
                                     else {%><%=Rs.getString("xz")%><% } }%></td> 
                            
                            <td width="5%" ><div align="center"><% if (Rs.getString("gyx").equals("1")) {%><font color="#ff0033">是</font><%} else{ %>否<% } %></div></td>
          ...
          <td>
          <a href="cjgl/cjgl.jsp?page=4&subpg=3&pgcode=1">首页</a>
           <%if (CurrPg>1){%>
            <a href="cjgl/cjgl.jsp?page=4&subpg=3&pgcode=<%=CurrPg-1%>">上一页</a> 
            <% } %>
            <%if (CurrPg<CountPg){%>
            <a href="cjgl/cjgl.jsp?page=4&subpg=3&pgcode=<%=CurrPg+1%>">下一页</a> 
            <% }  %>
            <a href="cjgl/cjgl.jsp?page=4&subpg=3&pgcode=<%=CountPg%>">最后一页</a>
            </td>
            </tr>
            </table>
        </div>
