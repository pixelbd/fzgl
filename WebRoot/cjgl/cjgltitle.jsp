...
<tr bgcolor="#ffffff">
    <td colspan="2"><div><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="870" height="150">
      <param name="movie" value="Flash/titletop/cjgl.swf">
      <param name="quality" value="high">
      <param name="wmode" value="transparent">
      <embed src="Flash/titletop/cjgl.swf" width="870" height="150" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent"></embed>
    </object></div></td>
  </tr>
 <tr >
...
<%if (islog) { 
   if (((String)session.getAttribute("deptment")).equals("1")||((String)session.getAttribute("deptment")).equals("admin")) 
    ...
    <td width="423" background="Images/menubg1.gif"  class="shadow">
     <a href="cjgl/cjgl.jsp?page=1" >&nbsp;段级车间管理&nbsp;</a>|
     <a href="cjgl/cjgl.jsp?page=2" >&nbsp;车间级管理&nbsp;</a>|
     <%if (((String)session.getAttribute("deptment")).equals("1")) { %><a href="cjgl/cjgl.jsp?page=4" >&nbsp;自控型班组(车间)考评标准查询&nbsp;</a><%} %>
     <%if (((String)session.getAttribute("deptment")).equals("admin")) { %><a href="cjgl/cjgl.jsp?page=3" >&nbsp;考评标准维护&nbsp;</a><%} %>
    </td> 
    ...
    <%
      ...
      {if  ((!((String) session.getAttribute("deptment")).equals("41"))
            ...
            <td width="423" background="Images/menubg1.gif"  class="shadow">
            <a href="cjgl/cjgl.jsp?page=1" >&nbsp;段级车间管理&nbsp;</a>|
            <a href="cjgl/cjgl.jsp?page=4" >&nbsp;自控型班组(车间)考评标准查询&nbsp;</a>
            </td> 
            <td  align="right" background="Images/menubg3.gif">：：[ <a href="index.jsp" target="_top">首页 </a> ] [<a href="logout.jsp" target="_top"> 注销 </a>]：：</td>
            <% }
       else { %> 
    ...
    <td width="423" background="Images/menubg1.gif"  class="shadow">
     ...
     <td align="right" background="Images/menubg3.gif"> ：：[<a href="cjgl/cjgl.jsp" onClick="Javascript:window.open('../login.jsp','','width=445,height=334')">立 即 登 录 </a>][ <a href="index.jsp" target="_top">首页 </a> ] ：：</td>  <%} %>
