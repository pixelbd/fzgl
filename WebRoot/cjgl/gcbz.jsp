  ...
  <body valign="top">
     <%
      ...
      <tr><td  width="100%" colspan="2">
          ...
          <tr><td  align="left"><font color="#800040">&nbsp;工程质量标准维护&nbsp;</font></td></tr>
     ...
     <table align="center" valign="top" width="100%"   cellpadding=-2 cellspacing=-2 bgcolor="#FFFFFF">
      <tr><td width="95%" height="28"  align="left" ><img   width="20" height="18" src="Images/add.gif" >
             <a href="cjgl/cjgl.jsp?page=3&subpg=2" onClick="Javascript:window.open('insgcbz.jsp?','','width=565,height=312')" >添加工程质量标准&nbsp;&nbsp;&nbsp;</a>
      <tr>
          <td>
          <div>
          <!-- 这里开始进行班组信息的查询 -->
          <table width="98%" border="0" align="center" cellpadding="1" cellspacing="1" >
                            ...
                            <td  width="63%"><div align="center" class="word_white">工程质量标准描述</div></td> 
                            <td width="3%"><div align="center" class="word_white">扣分</div></td>
                            <td width="3%"><div align="center" class="word_white">加分</div></td>
                ...
                if (Con!= null)
            	{
            		try
            		{
            			...
            			if (CountR>0)
            			{
                            ...
                            <td width="63%" ><div align="left"><%=Rs.getString("bz")%></div></td>
                            <td width="3%"  ><div align="center"><%=Rs.getString("kf")%></div></td>
                            <td width="3%"  ><div align="center"><%=Rs.getString("jf")%></div></td>
                            <% if ((islog) && (((String)session.getAttribute("deptment")).equals("admin")
                             ||((String)session.getAttribute("zw")).equals("cjadmin")
                             ||((String)session.getAttribute("zw")).equals("2"))) { %>
                            <td width="3%">
                               <div align="center"> 
                               <a href="cjgl/cjgl.jsp?page=3&subpg=2&pgcode=<%=CurrPg%>" title="修改" onClick="Javascript:window.open('upgcbz.jsp?code=<%=Rs.getString("code")%>','','width=565,height=312')">
                               <img src="Images/edit.gif" width="12" height="12" border="0"></a>
                               </div>
                            </td>
                            <td width="3%">
                               <div align="center">
                               <a href="cjgl/cjgl.jsp?page=3&subpg=2&pgcode=<%=CurrPg%>" title="删除" onClick="Javascript:window.open('delkpbz.jsp?code=<%=Rs.getString("code")%>&tabname=<%=tabname%>','','width=519,height=155')">
          ...
          <td>
          <a href="cjgl/cjgl.jsp?page=3&subpg=1&pgcode=1">首页</a>
           <%if (CurrPg>1){%>
            <a href="cjgl/cjgl.jsp?page=3&subpg=2&pgcode=<%=CurrPg-1%>">上一页</a> 
            <% } %>
            <%if (CurrPg<CountPg){%>
            <a href="cjgl/cjgl.jsp?page=3&subpg=2&pgcode=<%=CurrPg+1%>">下一页</a> 
            <% }  %>
            <a href="cjgl/cjgl.jsp?page=3&subpg=2&pgcode=<%=CountPg%>">最后一页</a>
            </td>
            </tr>
            </table>
        </div>
