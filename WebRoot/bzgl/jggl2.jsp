   ...
   { formcj.submit();}
	...
	<tr>
		 ...
		 <div>
          ...
          <td>
          <a href="bzgl/bzgl.jsp?page=1&submenu=1&cj=<%=chej%>&pgcodezg=1">首页</a>
           <%if (CurrPgzg>1){%>
            <a href="bzgl/bzgl.jsp?page=1&submenu=1&cj=<%=chej%>&pgcodezg=<%=CurrPgzg-1%>">上一页</a> 
            <% }  %>
            <%if (CurrPgzg<CountPgzg){%>
            <a href="bzgl/bzgl.jsp?page=12&submenu=1&cj=<%=chej%>&pgcodezg=<%=CurrPgzg+1%>">下一页</a> 
            <% } %>
            <a href="bzgl/bzgl.jsp?page=1&submenu=1&cj=<%=chej%>&pgcodezg=<%=CountPgzg%>">最后一页</a>
          </td>
          </tr>
        </table>
        </div>
