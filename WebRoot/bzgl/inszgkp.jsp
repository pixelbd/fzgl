...
if (formup.zrr.value=="")
{ alert("请选择被考评人！");formzg.zrr.focus();return;}
...
<table align="center" width="557" height="90"  bordercolor="#BEE09C" cellpadding="-2" cellspacing="-2"  >
  ...
  <tr>
    <td width="557" height="30" valign="top"><%if (!gzname.equals("")) { %>工长：<font color="#ff0080"><%=gzname%></font>【班组职工考评记录编辑】 <% } %>
    </td>
  </tr>
</table>
<table align="center" width="557"   border="0" bordercolor="#BEE09C" cellpadding="-2" cellspacing="-2" style="">
  ...
  <input type="hidden" name="bzcode" value="<%=bzcode%>"> <!-- bzcode班组编码 -->
    <input type="hidden" name="gzid" value="<%=gzid%>">     <!-- 工长身份证号码 -->
          ...
          <tr align="left">
            ...
            <table>
             <tr>
                ...
                <td  class="style1" >&nbsp;&nbsp;&nbsp;&nbsp;考核金额<input type="text" name="money"  value="0.00" size="6">元
   </td>
             </tr>
            </table>
            </td>
  ...
  <div><font color="#D43939">当前正在输入：
   ...
   else {if (chej.equals("44")) { %>郑州轮轴车间<%}} }}%>班组职工考评记录...</font></div>
